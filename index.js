...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array){
    let newArray = [];
    for (let i in array) {
      newArray.push(`name: ${array[i].animal_name}, scientific: ${array[i].scientific_name}`)
    }
    return newArray
  }
  ...
  */
  ...
  function lowerCaseNames(array){
    let newArray = array.map(function(item, i) {
      return array[i].animal_name.toLowerCase();
    });
    return newArray;
  }  
  ...
  */
  ...
  function lowPopulationAnimals(array){
    let moreThan5 = array.filter(item => item.population < 5); {
      return moreThan5
    }
  }
  ...
  */
  ...
  function USApop(array){
    let USApopAnimals = array.reduce(function(accumulator, item) {
      return accumulator + item.population;
    }, 0);
    return USApopAnimals
  }
...
// I converted all of my array method callbacks into arrow functions
...
*/
function CuboidMaker(object, length, width, height){
...
class CuboidMakerTwo {
  constructor(obj, length, width, height) {
